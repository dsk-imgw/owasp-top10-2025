# A10:2025 例外的な状況への不適切な対処 <img src="./assets/TOP_10_Icons_Final_Mishandling_of_Exceptional_Conditions.png" style="height:80px;width:80px" align="right">

## 背景

例外的な状況への不適切な対処は、2025 年に新設されたカテゴリです。このカテゴリには 24 件の CWE が含まれており、不適切なエラー処理、論理エラー、フェイル オープン、その他システムが遭遇する可能性のある異常な状況に起因する関連シナリオに焦点を当てています。このカテゴリには、以前はコード品質の低さと関連付けられていた CWE も含まれています。しかし、以前の分類はあまりにも一般的すぎたため、より具体的なこのカテゴリの方が、より適切なガイダンスを提供できると考えています。
